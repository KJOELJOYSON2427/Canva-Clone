...
exports.getUserDesigns=async (req, res)=>{
    try{
       ...
       return res.status(200).json({
        ...
        console.log('Error fetching design ',e)
        res.status(500).json({
            success:false,
...
exports.getUserDesignsByID=async (req, res)=>{
    try{
       ...
       res.status(200).json({
        ...
        console.log('Error fetching design by ID',e)
        res.status(500).json({
            success:false,
...
exports.saveDesign=async (req, res)=>{
    try{
        ...
        console.log('Error While saving design',e)
        res.status(500).json({
            success:false,
...
exports.deleteDesign=async (req, res)=>{
    try{
       ...
       return res.status(200).json({
        ...
        console.log('Error While delete design',e)
        res.status(500).json({
            success:false,
