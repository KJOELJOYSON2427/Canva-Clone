                ...
                <div className='p-6 flex-1'>
                   {
                         userSubscription?.isPremium ?(
                            ...
                            <div className='bg-green-50 border-green-100 rounded-lg p-4 mb-6'>
                                <div className='flex items-center'>
                        <CheckCircle className='h-5 w-5 text-green-500 mr-3'/>
                                   <p className='text-green-700 font-medium'>Premium active since {new Date(userSubscription?.premiumSince).toLocaleDateString()|| "recently"}</p>
                                </div>
                            </div>
                            ...
                            <div className='space-y-4'> 
                                 <div className='flex items-start gap-3 bg-white p-3 rounded-lg border'>
                                         ...
                                         <div>
                                          ...
                                          Access to all premium templates and assests
                                          </p>
                                         </div>
                                 </div>
                        ...
                        <p className='text-sm mb-4'>
                            Upgrage to <span className='font-semibold'>Canva Premium</span> and create quality design together
                            </p>
                            <div className='space-y-4'> 
                                 <div className='flex items-start gap-3 bg-white p-3 rounded-lg border'>
                                         <Crown className='h-5 w-5 text-primary mr-0.5'/> 
