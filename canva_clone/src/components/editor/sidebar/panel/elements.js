...
import { shapeDefinitions, shapeTypes } from "@/fabric/shapes/shape-definition";
...
function ElementsPanel() {
  ...
  const setCanvasRef = (getCurrentCanvaElement, shapeType) => {
    if (getCurrentCanvaElement) {
      canvasElementRef.current[shapeType] = getCurrentCanvaElement;
    }
  };
